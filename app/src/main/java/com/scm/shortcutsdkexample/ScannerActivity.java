...
public class ScannerActivity extends AppCompatActivity implements ShortcutSearchView.RecognitionCallbacks {
    ...
    private void init() {
        ...
        scannerView.setRecognitionCallbacks(this);
        scannerView.setChangeCameraModeCallback(new ShortcutSearchView.ChangeCameraModeCallback() {
            @Override
            public void onChangeCameraMode() {
                startActivity(new Intent(ScannerActivity.this, com.scm.shortcutsdkexample.CameraActivity.class));
            }
        });
